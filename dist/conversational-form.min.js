...
try {
    ...
    var CustomEvent = function(t, e) {
        ...
        return e = e || {
            ...
            cancelable: !1,
            detail: void 0
        }, A = document.createEvent("CustomEvent"), A.initCustomEvent(t, e.bubbles, e.cancelable, e.detail), n = A.preventDefault, A.preventDefault = function() {
            n.call(this);
            try {
...
! function(t) {
    var e = function() {
        function e(e) {
            var A = this;
            if (this.isDevelopment = !1, window.ConversationalForm || (window.ConversationalForm = this), !e.formEl) throw new Error("Conversational Form error, the formEl needs to be defined.");
            this.formEl = e.formEl, this.submitCallback = e.submitCallback, "" == this.formEl.getAttribute("cf-prevent-autofocus") && (t.UserInput.preventAutoFocus = !0), console.log(t.UserInput.preventAutoFocus, this.formEl, this.formEl.getAttribute("cf-prevent-autofocus")), this.dictionary = new t.Dictionary({
                data: e.dictionaryData,
                aiQuestions: e.dictionaryAI,
                userImage: e.userImage
            }), t.Helpers.setEmojiLib(), this.context = e.context ? e.context : document.body, this.tags = e.tags, setTimeout(function() {
                return A.init()
            }, 0)
        }
        return e.prototype.init = function() {
            var e = document.getElementById("conversational-form-development");
            if (e) this.isDevelopment = !0;
            else {
                var A = document.head || document.getElementsByTagName("head")[0],
                    n = document.createElement("link"),
                    o = "https://cdn.rawgit.com/space10-community/conversational-form/master/dist/conversational-form.min.css";
                n.type = "text/css", n.media = "all", n.setAttribute("rel", "stylesheet"), n.setAttribute("href", o), A.appendChild(n)
            }
            if ("fixed" != this.context.style.position && "absolute" != this.context.style.position && "relative" != this.context.style.position && (this.context.style.position = "relative"), !this.tags || 0 == this.tags.length) {
                this.tags = [];
                for (var i = [].slice.call(this.formEl.querySelectorAll("input, select, button"), 0), s = 0; s < i.length; s++) {
                    var r = i[s];
            ...
            console.log("Conversational Form > start > mapped DOM tags:", this.tags), console.log("----------------------------------------------"), this.flowManager = new t.FlowManager({
                cuiReference: this,
                tags: this.tags
            }), this.el = document.createElement("div"), this.el.id = "conversational-form", this.el.className = "conversational-form", this.context.appendChild(this.el), this.chatList = new t.ChatList({}), this.el.appendChild(this.chatList.el), this.userInput = new t.UserInput({}), this.el.appendChild(this.userInput.el), setTimeout(function() {
                e.el.classList.add("conversational-form--show"), e.flowManager.start()
            }, 0)
        }, e.prototype.doSubmitForm = function() {
            this.submitCallback ? this.submitCallback() : (this.formEl.submit(), this.remove())
        }, e.prototype.remove = function() {
            this.userInput.dealloc(), this.chatList.dealloc(), this.userInput = null, this.chatList = null, console.log(this, "remove() Conversational Form")
        ...
        }, e.ILLUSTRATE_APP_FLOW = !0, e
    }();
    t.ConversationalForm = e
}(cf || (cf = {})), window.addEventListener("load", function() {
        var t = document.querySelector("form[cf-form-element]"),
            e = document.querySelector("*[cf-context]");
        t && (window.ConversationalForm = new cf.ConversationalForm({
            formEl: t,
            context: e
        }))
    }, !1),
    function(t) {
        ...
        t.fn.conversationalForm = function() {
...
! function(t) {
    ...
    var e = function(e) {
        function A(t) {
            e.call(this, t), this.animateInTimer = 0, this._focus = !1, this.onFocusCallback = this.onFocus.bind(this), this.el.addEventListener("focus", this.onFocusCallback, !1), this.onBlurCallback = this.onBlur.bind(this), this.el.addEventListener("blur", this.onBlurCallback, !1)
        }
        return __extends(A, e), Object.defineProperty(A.prototype, "type", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(A.prototype, "positionVector", {
            get: function() {
                return this._positionVector
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(A.prototype, "tabIndex", {
            set: function(t) {
                this.el.tabIndex = t
            },
            enumerable: !0,
            ...
            enumerable: !0,
            configurable: !0
        }), A.prototype.onBlur = function(t) {
            this._focus = !1
        }, A.prototype.onFocus = function(e) {
            this._focus = !0, t.ConversationalForm.illustrateFlow(this, "dispatch", t.ControlElementEvents.ON_FOCUS, this.referenceTag), document.dispatchEvent(new CustomEvent(t.ControlElementEvents.ON_FOCUS, {
            ...
            var t = this;
            clearTimeout(this.animateInTimer), this.el.classList.contains("animate-in") ? (this.el.classList.remove("animate-in"), this.animateInTimer = setTimeout(function() {
                return t.el.classList.add("animate-in")
            }, 0)) : this.el.classList.add("animate-in")
        }, A.prototype.animateOut = function() {
            this.el.classList.add("animate-out")
        }, A.prototype.onChoose = function() {
            t.ConversationalForm.illustrateFlow(this, "dispatch", t.ControlElementEvents.SUBMIT_VALUE, this.referenceTag), document.dispatchEvent(new CustomEvent(t.ControlElementEvents.SUBMIT_VALUE, {
                detail: this
            }))
...
! function(t) {
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "active", {
            ...
            var e = t.detail,
                A = e.x + e.width < this.elementWidth ? 0 : e.x - e.width;
            A *= -1, this.listScrollController.setScroll(A, 0)
        }, e.prototype.onChatAIReponse = function(t) {
            ...
            n.active || !this.tableableRows || 0 != this.rowIndex && 1 != this.rowIndex || this.tableableRows[this.rowIndex][this.columnIndex].el.focus()
        }, e.prototype.validateRowColIndexes = function() {
            this.el.classList.contains("two-row") ? 1 : 0;
            return this.tableableRows[this.rowIndex] ? (this.columnIndex < 0 && (this.columnIndex = this.tableableRows[this.rowIndex].length - 1), this.columnIndex > this.tableableRows[this.rowIndex].length - 1 && (this.columnIndex = 0), !0) : (this.resetTabList(), !1)
        }, e.prototype.updateRowIndex = function(t) {
            var e = this.rowIndex;
            if (this.rowIndex += t, this.tableableRows[this.rowIndex])
                for (var A = this.tableableRows[e][this.columnIndex].positionVector, n = this.tableableRows[this.rowIndex], o = 1e13, i = 0; i < n.length; i++) {
                    var s = n[i];
            ...
            if (this.el.classList.remove("animate-in"), this.infoElement.classList.remove("show"), this.elements)
                for (var e = this.getElements(), A = 0; A < e.length; A++) {
                    var n = e[A];
                    n.animateOut()
                }
            ...
            if (n.length > 1) {
                ...
                var g = this.filterListNumberOfVisible != o.length;
        ...
        }, e.prototype.setFocusOnElement = function(t) {
            this.getElements();
            this.tableableRows && t != -1 ? this.tableableRows[0][0].el.focus() : this.rowIndex = 0
        }, e.prototype.updateStateOnElements = function(t) {
            if (this.list.classList.add("disabled"), "RadioButton" == t.type)
                for (var e = this.getElements(), A = 0; A < e.length; A++) {
                    var n = e[A];
                    n != t && (n.checked = !1)
                }
            ...
            if (this.elements && this.elements.length > 0) switch (this.elements[0].type) {
                ...
                case "OptionsList":
                    ...
                    if (e.controlElements && e.controlElements[0])
                        for (var r = 0; r < e.controlElements.length; r++) {
                            e.controlElements[r];
            ...
            s ? this.filterListNumberOfVisible = this.elements[0].elements.length : this.filterListNumberOfVisible = e.length, new Promise(function(t, e) {
                ...
                var e = A.el.classList.contains("one-row") ? 52 : A.el.classList.contains("two-row") ? 102 : 0,
                    n = {
                        height: e
                    };
                t.ConversationalForm.illustrateFlow(A, "dispatch", t.UserInputEvents.CONTROL_ELEMENTS_ADDED, n), document.dispatchEvent(new CustomEvent(t.UserInputEvents.CONTROL_ELEMENTS_ADDED, {
                    detail: n
                }))
            })
                ...
                if (e.length > 0) {
                    ...
                    a ? (A.el.classList.add("two-row"), A.listWidth = Math.max(r, Math.round(n[Math.floor(n.length / 2)] + 50)), A.list.style.width = A.listWidth + "px") : A.el.classList.add("one-row"), setTimeout(function() {
                        ...
                        for (var o = e.slice(), i = o.sort(function(t, e) {
                                return t.positionVector.x == e.positionVector.x ? 0 : t.positionVector.x < e.positionVector.x ? -1 : 1
            ...
            this.tableableRows = null, cancelAnimationFrame(this.rAF), this.rAF = null, this.el.removeEventListener("scroll", this.onScrollCallback, !1), this.onScrollCallback = null, document.removeEventListener(t.ControlElementEvents.ON_FOCUS, this.onElementFocusCallback, !1), this.onElementFocusCallback = null, document.removeEventListener(t.ChatResponseEvents.AI_QUESTION_ASKED, this.onChatAIReponseCallback, !1), this.onChatAIReponseCallback = null, document.removeEventListener(t.UserInputEvents.KEY_CHANGE, this.onUserInputKeyChangeCallback, !1), this.onUserInputKeyChangeCallback = null, document.removeEventListener(t.FlowEvents.USER_INPUT_UPDATE, this.userInputUpdateCallback, !1), this.userInputUpdateCallback = null, this.listScrollController.dealloc()
        }, e
    }();
    t.ControlElements = e
}(cf || (cf = {}));
...
! function(t) {
    var e = function() {
        ...
        return e.prototype.onListNavButtonsClick = function(t) {
            ...
            var e = this;
            this.rAF && cancelAnimationFrame(this.rAF), this.startX += .2 * (this.startXTarget - this.startX), this.inputAccerlation += (this.inputAccerlationTarget - this.inputAccerlation) * (this.interacting ? .2 : .05);
            var A = .25;
            this.inputAccerlationTarget *= A, this.direction += .2 * (this.directionTarget - this.direction), this.mouseSpeed += .2 * (this.mouseSpeedTarget - this.mouseSpeed), this.direction += this.mouseSpeed, this.xTarget += .05 * this.inputAccerlation, this.xTarget > 0 && (this.xTarget += .3 * (0 - this.xTarget)), this.xTarget < this.max && (this.xTarget += .3 * (this.max - this.xTarget)), this.x += .4 * (this.xTarget - this.x);
            var n = Math.round(this.x);
            n < 0 && (this.prevButton.classList.contains("active") || this.prevButton.classList.add("active"), this.prevButton.classList.contains("cf-gradient") || this.prevButton.classList.add("cf-gradient")), 0 == n && (this.prevButton.classList.contains("active") && this.prevButton.classList.remove("active"), this.prevButton.classList.contains("cf-gradient") && this.prevButton.classList.remove("cf-gradient")), n > this.max && (this.nextButton.classList.contains("active") || this.nextButton.classList.add("active"), this.nextButton.classList.contains("cf-gradient") || this.nextButton.classList.add("cf-gradient")), n <= this.max && (this.nextButton.classList.contains("active") || this.nextButton.classList.remove("active"), this.nextButton.classList.contains("cf-gradient") || this.nextButton.classList.remove("cf-gradient"));
            var o = this.x;
    ...
    var e = function() {
        function t(e) {
            this.data = {
                ...
                robot: {
                    thumb: "data:image/png;base64,",
        ...
        return t.get = function(e) {
            ...
            return n
        }, t.getAIResponse = function(e) {
            var A = t.instance,
                n = A.AIQuestions[t.AIType][e];
            if (n) {
                var o = n.split("|");
                n = o[Math.floor(Math.random() * o.length)]
            } else {
                var i = A.AIQuestions[t.AIType].general.split("|");
            ...
            for (var A = "", n = 0; n < e.length; n++) {
                var o = e[n],
                    i = e.length > 1 && n == e.length - 2 ? t.get("user-reponse-and") : ", ";
                A += o + (n < e.length - 1 ? i : "")
            }
            return A
...
! function(cf) {
    var Tag = function() {
        function Tag(options) {
            this.domElement = options.domElement, this.domElement.tabIndex = -1, options.questions && (this.questions = options.questions), this.domElement.getAttribute("cf-validation") && (this.validationCallback = eval(this.domElement.getAttribute("cf-validation"))), this.domElement.getAttribute("cf-display-if") && (this._displayCondition = this.domElement.getAttribute("cf-display-if")), this.domElement.getAttribute("pattern") && (this.pattern = new RegExp(this.domElement.getAttribute("pattern"))), this.defaultValue = this.domElement.value, "group" != this.type && console.log("Tag registered:", this.type), this.findAndSetQuestions()
        }
        return Object.defineProperty(Tag.prototype, "type", {
            ...
            get: function() {
                return this._label || this.findAndSetLabel(), this._label ? this._label : cf.Dictionary.getAIResponse(this.type)
            },
            enumerable: !0,
            configurable: !0
            ...
            get: function() {
                return this.questions && 0 != this.questions.length ? this.questions[Math.floor(Math.random() * this.questions.length)] : cf.Dictionary.getAIResponse(this.type)
            },
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(Tag.prototype, "errorMessage", {
            get: function() {
                return this.errorMessages || (this.domElement.getAttribute("cf-error") ? this.errorMessages = this.domElement.getAttribute("cf-error").split("|") : "file" == this.type ? this.errorMessages = [cf.Dictionary.get("input-placeholder-file-error")] : this.errorMessages = [cf.Dictionary.get("input-placeholder-error")]), this.errorMessages[Math.floor(Math.random() * this.errorMessages.length)]
            },
            enumerable: !0,
            configurable: !0
            ...
            var e = !0,
                A = t.text;
            return this.pattern && (e = this.pattern.test(A)), e && this.validationCallback && (e = this.validationCallback(A, this)), "" == A && (e = !1), e && "file" != this.type && (this.domElement.value = A), e
        }, Tag.prototype.findAndSetQuestions = function() {
            if (!this.questions) {
                if (this.domElement.getAttribute("cf-questions")) this.questions = this.domElement.getAttribute("cf-questions").split("|");
                else {
                    var t = this.domElement.getAttribute("id"),
                        e = document.querySelector("label[for='" + t + "']");
        ...
        }, Tag.prototype.shouldBeDisplayed = function(previousTags) {
            if (!this._displayCondition) return !0;
            var conditionExpression = this._displayCondition.replace("AND", "&&").replace("OR", "||").replace(/ CONTAINS ?(.*) ?/, ".indexOf$1!==-1");
            previousTags.forEach(function(t) {
                conditionExpression = conditionExpression.replace(new RegExp(t.name, "g"), '"' + t.value + '"')
            });
            try {
    ...
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "type", {
            ...
            get: function() {
                ...
                if (e) return e;
                var A = t.Dictionary.getAIResponse(this.getGroupTagType());
                return A
            },
            enumerable: !0,
            configurable: !0
            ...
            get: function() {
                if (!this.errorMessages) {
                    this.errorMessages = [t.Dictionary.get("input-placeholder-error")];
                    for (var e = 0; e < this.elements.length; e++) {
                        this.elements[e];
                        this.elements[e].domElement.getAttribute("cf-error") && (this.errorMessages = this.elements[e].domElement.getAttribute("cf-error").split("|"))
                    }
                }
            ...
            this.elements = null, this.errorMessages = null
        }, e.prototype.getGroupTagType = function() {
            return this.elements[0].type
        }, e.prototype.setTagValueAndIsValid = function(t) {
            var e = !1,
                A = this.elements[0].type;
            switch (A) {
                case "radio":
                    for (var n = [], o = !1, i = 0; i < t.controlElements.length; i++) {
                        var s = t.controlElements[i],
                            r = this.elements[this.elements.indexOf(s.referenceTag)];
                        s.visible && (n.push(s), r == s.referenceTag && (r.domElement.checked = s.checked, !o && s.checked && (o = !0)))
                    }
                    if (e || 1 != n.length) !e && o && (e = o);
                    else {
                        var s = n[0],
                            r = this.elements[this.elements.indexOf(s.referenceTag)];
                        s.checked = !0, r.domElement.checked = !0, e = !0
                    }
                    break;
                case "checkbox":
                    e = !0;
                    for (var i = 0; i < t.controlElements.length; i++) {
                        var s = t.controlElements[i],
                            r = this.elements[this.elements.indexOf(s.referenceTag)];
                        r.domElement.checked = s.checked
                    }
            }
            return e
        }, e.prototype.shouldBeDisplayed = function(t) {
            return this.elements = this.elements.filter(function(e) {
                return e.shouldBeDisplayed(t)
...
! function(t) {
    var e = function(t) {
        function e(e) {
            t.call(this, e), "text" == this.type || "email" == this.type || "tel" == this.type || "checkbox" == this.type || "radio" == this.type || "password" == this.type || "file" == this.type
        }
...
! function(t) {
    var e = function(e) {
        function A(A) {
            e.call(this, A), this.optionTags = [];
            for (var n = this.domElement.getElementsByTagName("option"), o = 0; o < n.length; o++) {
                var i = n[o],
                    s = t.Tag.createTag(i);
                s && this.optionTags.push(s)
            }
        }
        return __extends(A, e), Object.defineProperty(A.prototype, "type", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), Object.defineProperty(A.prototype, "multipleChoice", {
            get: function() {
                return this.domElement.hasAttribute("multiple")
            },
            enumerable: !0,
            configurable: !0
        }), A.prototype.setTagValueAndIsValid = function(t) {
            for (var e = !1, A = [], n = 0; n < this.optionTags.length; n++)
                for (var o = this.optionTags[n], i = 0; i < t.controlElements.length; i++) {
                    var s = t.controlElements[i];
                    s.referenceTag == o && (o.selected = s.selected, !e && o.selected && (e = !0), s.visible && A.push(s))
                }
            if (!e && 1 == A.length) {
                var r = A[0],
                    o = this.optionTags[this.optionTags.indexOf(r.referenceTag)];
                r.selected = !0, o.selected = !0, e = !0
            }
            return e
        }, A
    }(t.Tag);
...
! function(t) {
    var e = function(t) {
        function e(e) {
            t.call(this, e), "submit" == this.domElement.getAttribute("type") || "button" == this.domElement.getAttribute("type")
        }
...
! function(t) {
    var e = function(t) {
        function e(e) {
            t.call(this, e), this.clickCallback = this.onClick.bind(this), this.el.addEventListener("click", this.clickCallback, !1), this.mouseDownCallback = this.onMouseDown.bind(this), this.el.addEventListener("mousedown", this.mouseDownCallback, !1)
        }
...
! function(t) {
    ...
    var e = function(e) {
        function A() {
            e.apply(this, arguments), this.isMultiChoice = !1
        }
        return __extends(A, e), Object.defineProperty(A.prototype, "type", {
            get: function() {
                return "OptionButton"
            ...
            t.ConversationalForm.illustrateFlow(this, "dispatch", t.OptionButtonEvents.CLICK, this), document.dispatchEvent(new CustomEvent(t.OptionButtonEvents.CLICK, {
                detail: this
            }))
...
! function(t) {
    var e = function(e) {
        function A(A) {
            if (e.call(this, A), this.maxFileSize = 1e11, this.loading = !1, this.submitTimer = 0, this.fileName = "", !t.Helpers.caniuse.fileReader()) throw new Error("Conversational Form Error: No FileReader available for client.");
            var n = this.referenceTag.domElement.getAttribute("cf-max-size") || this.referenceTag.domElement.getAttribute("max-size");
            if (n) {
                var o = parseInt(n, 10);
                this.maxFileSize = o
            }
            this.progressBar = this.el.getElementsByTagName("cf-upload-file-progress-bar")[0], this.onDomElementChangeCallback = this.onDomElementChange.bind(this), this.referenceTag.domElement.addEventListener("change", this.onDomElementChangeCallback, !1)
        }
        return __extends(A, e), Object.defineProperty(A.prototype, "value", {
            get: function() {
            ...
            enumerable: !0,
            configurable: !0
        }), A.prototype.onDomElementChange = function(e) {
            var A = this,
                n = new FileReader;
            n.onerror = function(t) {
                ...
                var o = A.referenceTag.domElement.files[0],
                    i = o ? o.size : A.maxFileSize + 1;
                if (i > A.maxFileSize) {
                    n.abort();
                    var s = {
                        errorText: t.Dictionary.get("input-placeholder-file-size-error")
                    };
                    t.ConversationalForm.illustrateFlow(A, "dispatch", t.FlowEvents.USER_INPUT_INVALID, s), document.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID, {
                        detail: s
                    }))
                } else {
                    A.fileName = o.name, A.loading = !0, A.animateIn();
                    var r = Math.floor(Math.log(i) / Math.log(1024)),
                        a = ["b", "kb", "mb", "gb"];
                    r = Math.min(a.length - 1, r);
                    var l = 1 * Number((i / Math.pow(1024, r)).toFixed(2)) + " " + a[r],
                        g = o.name + " (" + l + ")";
                    A.el.getElementsByTagName("cf-upload-file-text")[0].innerHTML = g, document.dispatchEvent(new CustomEvent(t.ControlElementEvents.PROGRESS_CHANGE, {
                        detail: t.ControlElementProgressStates.BUSY
                    }))
                }
            }, n.onload = function(e) {
                A.progressBar.classList.add("loaded"), A.submitTimer = setTimeout(function() {
                    document.dispatchEvent(new CustomEvent(t.ControlElementEvents.PROGRESS_CHANGE, {
                        detail: t.ControlElementProgressStates.READY
                    })), A.el.classList.remove("animate-in"), A.onChoose()
                }, 2e3)
            }, n.readAsBinaryString(e.target.files[0])
        }, A.prototype.animateIn = function() {
            this.loading && e.prototype.animateIn.call(this)
        }, A.prototype.onClick = function(t) {}, A.prototype.triggerFileSelect = function() {
...
! function(t) {
    ...
    var e = function(e) {
        ...
        return __extends(A, e), Object.defineProperty(A.prototype, "active", {
            ...
            enumerable: !0,
            configurable: !0
        }), A.prototype.getInputValue = function() {
            ...
            var o = e.detail;
            this.inputElement.setAttribute("data-value", this.inputElement.value), this.inputElement.value = "", this.el.setAttribute("error", ""), this.disabled = !0, this.inputElement.setAttribute("placeholder", o.errorText || this.currentTag.errorMessage), clearTimeout(this.errorTimer), this.errorTimer = setTimeout(function() {
                n.disabled = !1, n.el.removeAttribute("error"), n.inputElement.value = n.inputElement.getAttribute("data-value"), n.inputElement.setAttribute("data-value", ""), n.inputElement.setAttribute("placeholder", t.Dictionary.get("input-placeholder")), n.setFocusOnInput()
            }, A.ERROR_TIME)
        }, A.prototype.onFlowUpdate = function(e) {
            var n = this;
            t.ConversationalForm.illustrateFlow(this, "receive", e.type, e.detail), this.el.classList.contains("animate-in") || this.el.classList.add("animate-in"), this.currentTag = e.detail, this.el.setAttribute("tag-type", this.currentTag.type), clearTimeout(this.errorTimer), this.el.removeAttribute("error"), this.inputElement.setAttribute("data-value", ""), this.inputElement.value = "", this.inputElement.setAttribute("placeholder", t.Dictionary.get("input-placeholder")), this.resetValue(), A.preventAutoFocus || this.setFocusOnInput(), this.controlElements.reset(), "group" == this.currentTag.type ? this.buildControlElements(this.currentTag.elements) : this.buildControlElements([this.currentTag]), setTimeout(function() {
                n.disabled = !1
            }, 1e3)
            ...
            if (e.keyCode == t.Dictionary.keyCodes.shift) this.shiftIsDown = !1;
                ...
                A || (e.preventDefault(), this.shiftIsDown && this.controlElements.active ? this.controlElements.setFocusOnElement(this.controlElements.length - 1) : this.setFocusOnInput())
            }
            if (!this.el.hasAttribute("disabled")) {
                var o = this.getFlowDTO();
                if (e.keyCode == t.Dictionary.keyCodes.enter || e.keyCode == t.Dictionary.keyCodes.space)
                    ...
                    e.preventDefault();
                    var i = "group" == this.currentTag.type ? this.currentTag.getGroupTagType() : this.currentTag.type;
                    if ("select" == i || "checkbox" == i) {
                        var s = this.currentTag;
                    ...
                    } else "group" == this.currentTag.type && this.dispatchKeyChange(o, e.keyCode)
            ...
            t.ConversationalForm.illustrateFlow(this, "dispatch", t.UserInputEvents.KEY_CHANGE, e), document.dispatchEvent(new CustomEvent(t.UserInputEvents.KEY_CHANGE, {
                detail: {
                    dto: e,
                    keyCode: A,
            ...
            this.controlElements.active && this.controlElements.setFocusOnElement(-1)
        }, A.prototype.setFocusOnInput = function() {
            this.inputElement.focus()
        }, A.prototype.onEnterOrSubmitButtonSubmit = function() {
            "file" == this.currentTag.type ? this.controlElements.getElement(0).triggerFileSelect() : this.doSubmit()
        }, A.prototype.doSubmit = function() {
            var e = this.getFlowDTO();
            this.disabled = !0, this.el.removeAttribute("error"), this.inputElement.setAttribute("data-value", ""), t.ConversationalForm.illustrateFlow(this, "dispatch", t.UserInputEvents.SUBMIT, e), document.dispatchEvent(new CustomEvent(t.UserInputEvents.SUBMIT, {
                detail: e
            }))
...
! function(t) {
    ...
    var e = function(e) {
        function A(t) {
            e.call(this, t), this.tag = t.tag
        }
        return __extends(A, e), Object.defineProperty(A.prototype, "visible", {
            set: function(t) {
            ...
            if (this.response && 0 != this.response.length) {
                if (A.innerHTML = this.response, A.setAttribute("value-added", ""), A.removeAttribute("thinking"), e.controlElements && e.controlElements[0]) switch (e.controlElements[0].type) {
                    case "UploadFileUI":
                        A.classList.add("file-icon");
                        var n = document.createElement("span");
                        n.innerHTML = t.Dictionary.get("icon-type-file"), A.insertBefore(n.children[0], A.firstChild)
                }
                this.visible || (this.visible = !0), this.isAIReponse && (t.ConversationalForm.illustrateFlow(this, "dispatch", t.ChatResponseEvents.AI_QUESTION_ASKED, this.response), document.dispatchEvent(new CustomEvent(t.ChatResponseEvents.AI_QUESTION_ASKED, {
                    detail: this
                })))
            } else A.setAttribute("thinking", "")
        }, A.prototype.processResponse = function() {
            if (this.response = t.Helpers.emojify(this.response), "password" == this.tag.type && !this.isAIReponse) {
                for (var e = "", A = 0; A < this.response.length; A++) e += "*";
                this.response = e
            }
        }, A.prototype.setData = function(A) {
            var n = this;
            this.image = A.image, this.response = "", this.isAIReponse = A.isAIReponse, e.prototype.setData.call(this, A), setTimeout(function() {
                n.visible = n.isAIReponse || n.response && n.response.length > 0, n.setValue(), n.isAIReponse ? setTimeout(function() {
                    return n.setValue({
                        text: A.response
                    })
                }, t.Helpers.lerp(Math.random(), 500, 900)) : setTimeout(function() {
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(A, e), A.prototype.onControlElementsAddedToUserInput = function(t) {
            ...
            var A = e.detail.dto;
            if (t.ConversationalForm.illustrateFlow(this, "receive", e.type, A), this.currentResponse) {
                var n = A.text || A.input.getInputValue();
                n && 0 != n.length ? this.currentResponse.visible || (this.currentResponse.visible = !0) : this.currentResponse.visible = !1
            }
        }, A.prototype.onUserInputUpdate = function(e) {
            if (t.ConversationalForm.illustrateFlow(this, "receive", e.type, e.detail), !this.currentResponse) throw new Error("No current response ..?");
            var A = e.detail;
            this.flowDTOFromUserInputUpdate = A
        }, A.prototype.onFlowUpdate = function(e) {
            t.ConversationalForm.illustrateFlow(this, "receive", e.type, e.detail);
            var A = e.detail;
            this.flowDTOFromUserInputUpdate && (this.flowDTOFromUserInputUpdate.text || (this.flowDTOFromUserInputUpdate.text = t.Dictionary.get("user-reponse-missing")), this.currentResponse.setValue(this.flowDTOFromUserInputUpdate));
            var n = t.Dictionary.getAIResponse("thumb"),
                o = "";
            o = A.question, this.flowDTOFromUserInputUpdate && (o = o.split("{previous-answer}").join(this.flowDTOFromUserInputUpdate.text)), this.createResponse(!0, A, o, n), this.createResponse(!1, A)
        }, A.prototype.createResponse = function(e, A, n, o) {
            void 0 === n && (n = null), void 0 === o && (o = t.Dictionary.get("user-image")), this.currentResponse = new t.ChatResponse({
                tag: A,
                isAIReponse: e,
                response: n,
                image: o
...
! function(t) {
    ...
    var e = function() {
        function e(e) {
            this.maxSteps = 0, this.step = 0, this.stepTimer = 0, this.cuiReference = e.cuiReference, this.tags = e.tags, this.maxSteps = this.tags.length, this.userInputSubmitCallback = this.userInputSubmit.bind(this), document.addEventListener(t.UserInputEvents.SUBMIT, this.userInputSubmitCallback, !1)
        }
        return Object.defineProperty(e.prototype, "currentTag", {
            ...
            t.ConversationalForm.illustrateFlow(this, "receive", e.type, e.detail);
            var n = e.detail;
            this.currentTag.setTagValueAndIsValid(n) ? (t.ConversationalForm.illustrateFlow(this, "dispatch", t.FlowEvents.USER_INPUT_UPDATE, n), n = n.input.getFlowDTO(), document.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_UPDATE, {
                detail: n
            })), setTimeout(function() {
                return A.nextStep()
            }, 250)) : (t.ConversationalForm.illustrateFlow(this, "dispatch", t.FlowEvents.USER_INPUT_INVALID, n), document.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID, {
                detail: n
            })))
            ...
            this.step == this.maxSteps ? this.cuiReference.doSubmitForm() : this.shouldStepBeDisplayed() ? (this.step %= this.maxSteps, this.showStep()) : (this.tags.splice(this.step, 1), this.maxSteps--, this.step--, this.nextStep())
        }, e.prototype.showStep = function() {
            t.ConversationalForm.illustrateFlow(this, "dispatch", t.FlowEvents.FLOW_UPDATE, this.currentTag), document.dispatchEvent(new CustomEvent(t.FlowEvents.FLOW_UPDATE, {
                detail: this.currentTag
            }))
        }, e.prototype.shouldStepBeDisplayed = function() {
